...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='assemblywright-developer-repair-e2e-') as temp:
        ...
        try:
            ...
            loop_feature = next(feature for feature in durable['queue_v11'] if feature['id'] == loop_id)
            ...
            exhausted_feature = next(feature for feature in durable['queue_v11'] if feature['id'] == exhausted_id)
