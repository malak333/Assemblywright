...
require_text "master schema version" "$MASTER_CRATE" "pub const MASTER_SCHEMA_VERSION: i64 = 3;"
...
require_text "master enrollment schema migration E2E" "$MASTER_IDENTITY_E2E" "schema_v1_migrates_transactionally_to_enrollment_identity_and_event_cursor_v3"
