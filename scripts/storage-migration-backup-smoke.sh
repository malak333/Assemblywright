...
printf '\nAssemblywright storage migration backup smoke: ok\n'
printf 'Proof boundary: focused Rust storage tests for legacy DB backup, restore after migration-open failure, newer-schema diagnostics, and schema v1-v13 fixture preservation; no installer upgrade or Finder/LaunchServices recovery proof.\n'
