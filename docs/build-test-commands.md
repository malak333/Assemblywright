...
ticket, and app zip payload before writing the manifest. It also requires the
...
staple validation, Gatekeeper assessment, and artifact digests that match the
current zip/pkg files. It rejects disabled
