...
flowchart TB
    ...
    subgraph Core["jarvis-core"]
        ...
        ProviderEnvelope --> LocalToolDiscipline["local-model tool discipline: advertised first-party inventory, invalid-tool rejection, bounded schema/policy path"]
