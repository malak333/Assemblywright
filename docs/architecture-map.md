...
release, plugin installation/runtime hardening, owner-recorded live
microphone/Speech capture, spoken transcript handoff, live audio-output
validation for the signed installed app, packaged app smoke tests, and
operational release evidence. The current
