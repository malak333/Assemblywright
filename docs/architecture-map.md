...
flowchart TB
    ...
    subgraph Core["jarvis-core"]
        ...
        IPC --> Inspection["/tasks, /audit, /activity/summary, /activity/events, /model-routes, /memory, /permissions/grants, /permissions/policy-review incl scheduler triggers and memory review, /plugins/manifests, /plugins/installed"]
