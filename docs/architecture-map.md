...
- `jarvis-core::ipc`: Axum loopback HTTP API for `/health`, `/commands`,
  ...
  `/emergency-pause`, and `/scheduler/jobs`. The command endpoint runs the runtime with
